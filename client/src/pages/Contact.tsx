              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@modernshop.com</p>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Questions about your order or shipping</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900">Product Questions</h4>
                    <p className="text-sm text-gray-600">Need help choosing the right product</p>
                  </div>
                  <div>
